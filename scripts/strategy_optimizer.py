...
def analyze():
    ...
    recommended = {
        "strategy_version": "v3-whale-strict",
        "chain": "solana",
        "initial_cash_usd": 1000.0,
        "scan_interval_seconds": 3600,
        "max_positions": 5,
        "position_cash_pct": 0.1,
        "max_position_cash_pct": 0.15,
        ...
        "wallet_types": "3",
        "min_holders": 200,
        "max_top10_holder_pct": 25.0,
        "max_sold_ratio_pct": 65.0,
        "min_market_cap_usd": 25000.0,
        "max_market_cap_usd": 600000.0,
        "price_poll_sleep_seconds": 0.2,
        "notes": [
            "Whale-only entries; SmartMoney disabled for new opens",
            "Tighter sold_ratio and higher min_score from closed-trade stats",
            "Faster stop (-15%) and slightly lower TP (38%) to cut tail risk",
            "Smaller position size (10%) + higher cash reserve",
        ],
    }
